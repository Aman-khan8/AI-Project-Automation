function TaskCard({ task, onStatusToggle, onEdit, onDelete }) {
  ...
  return (
    <div className="bg-slate-800/60 border border-slate-700/50 rounded-xl p-4 card-hover">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-3">
            ...
            <button
              ...
              className={`text-xs font-medium px-2 py-0.5 rounded-full cursor-pointer transition-opacity hover:opacity-80 ${statusStyles[task.status]}`}
            >
